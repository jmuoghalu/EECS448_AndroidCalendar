...
public class WeekView extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(array[2] == 2016) // if the year is set to 2016
        {
            textView.setText("2016");
        }
        else // the year is set to 2017
        {
    ...
    public void fillWeek()
    {
        ...
        else if(array[7] == 1 && array[4] > 1) //First week and starts with another month
        {
            ...
            t = (TextView) findViewById(R.id.saturday);
            t.setText("Saturday, " + getMonth(array[1]) + "1"); // otherwise, Saturday must be the first of the next month
        }
        else if(array[7] == 5 && array[4]+6 > array[5]) // if Week 5 goes into next month
        {
            t.setText("Sunday, " + getMonth(array[1]) + array[4]);
            t = (TextView) findViewById(R.id.monday);
            if(array[4]+1 > array[5]) // if the month ends on Sunday, Monday is the 1st of next month
            {
