...
public class MonthView extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view)
    {
        switch(view.getId())
        {
            ...
            case(R.id.sixthWeek):
            {
                ...
                else if(array[3] == 7 && array[5] > 29) // if the 1st day of the month was Saturday and there are at least 30 days in the month
                {
     ...
     * @param start the day the month starts on
     * @param end the number of days in the month
     */
